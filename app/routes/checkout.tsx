...
/**
 * Everywhere. The store ships worldwide, with the United States first because
 * that is where most of the orders come from; the rest is every country there
 * is, alphabetically. A wallet can hand over any of these and be accepted.
 */
...
async function payAction({
  ...
  /**
   * Re-priced means the figure the customer was looking at is not the figure
   * that will be charged. It used to mean "the intent's amount is not the
   * cart's amount" — which is also true whenever a discount was applied after
   * the intent was first made, and that turned a perfectly good Apple Pay
   * into "choose a different card" with nothing wrong at all. The browser now
        ...
        <>
          ...
          {repriced ? (
            <div className={cn.alert} style={{ marginTop: 16 }}>
              Your total is now {money(total)}. Press Pay — or tap Apple Pay / Google Pay — once more to
              be charged that amount. Nothing has been charged yet.
            </div>
          ) : null}
